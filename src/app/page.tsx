...
function PlayingCard({
  ...
  return (
    ...
    >
      <span className="text-sm font-semibold tracking-[0.2em]">{value}</span>
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  ...
                  <p className="max-w-2xl text-base leading-7 text-white/76 sm:text-lg">
                    The UI shell is ready for hole-card selection, community
                    cards, simulation controls, and probability analysis.
                  </p>
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                {playerCards.map((card) => (
                  <PlayingCard key={card} value={card} highlighted />
                ))}
              </div>
            </div>
            <div className="space-y-3">
        ...
        <div className="grid gap-6">
          <Card className="bg-white/78">
            <CardHeader>
              ...
              <CardDescription>
                Reserve space for deck state, suit filters, and street-aware
                picking.
              </CardDescription>
            </CardHeader>
            <CardContent className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-dashed border-border bg-muted/35 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Interactive deck grid will go here.
                </p>
              </div>
              <div className="rounded-2xl border border-dashed border-border bg-muted/35 p-4">
                <p className="text-sm font-medium">Board card picker</p>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Flop, turn, and river placeholders are ready.
                </p>
              </div>
            </CardContent>
          </Card>
